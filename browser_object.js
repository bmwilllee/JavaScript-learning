...
document.title = 'learning JavaScript everyday';
...
//	这个对象属于历史遗留对象，对于现代Web页面来说，由于大量使用AJAX和页面交互
//	简单粗暴地调用history.back()可能会让用户感到非常愤怒

//	新手开始设计Web页面时喜欢在登录页登录成功时调用history.back()，试图回到登录前的页面
//	这是一种错误的方法
