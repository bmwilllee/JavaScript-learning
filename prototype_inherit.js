...
PrimaryStudent.prototype.grade = function(){
	return this.grade;
};
...
// 验证原型:
xiaoming.__props__ === PrimaryStudent.prototype;	// true
xiaoming.__props__ === Student.prototype;			// true
