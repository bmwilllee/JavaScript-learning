...
//	XML本身不算复杂，但是，加上DTD、XSD、XPath、XSLT等一大堆复杂的规范以后，任何正常的软件开发人员碰到XML都会感觉头大了
//	最后大家发现，即使你努力钻研几个月，也未必搞得清楚XML的规范
...
JSON.stringify(xiaoming); // '{"Name":"小明","Age":14,"skills":["JavaScript","Java","Python","Lisp"]}'
...
JSON.parse('{"name":"小明","age":14}', function(keym value){
	if(key === 'name'){
		return value + '童鞋'
	}
	return value;
