...
//	Map具有以下方法：
var ma = new Map();	// create a empty map

m.set('Adam', 98);	// add a new key-value
m.set('Will', 99);

m.has('Adam');	// true
m.get('Adam');	// get the value of key 'Adam'

m.delete('Adam');	// delete the key 'Adam'
...
var s1 = new Set();	// create an empty set
